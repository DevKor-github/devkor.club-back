...
export class Migration20250709024130 extends Migration {
  override async up(): Promise<void> {
    this.addSql(
      `create table "posts" ("id" varchar(255) not null, "title" varchar(255) not null, "content" varchar(255) not null, "author" varchar(255) not null, "position" varchar(255) not null, "tags" text[] not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, constraint "posts_pkey" primary key ("id"));`,
    );
